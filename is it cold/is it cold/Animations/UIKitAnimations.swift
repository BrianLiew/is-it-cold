...
func night_clear_sky(view: UIView) -> Void {
    // graphics
    let background = CAGradientLayer()
    background.frame = view.bounds
    background.colors = [
        UIColor(displayP3Red: 0, green: 0.25, blue: 0.25, alpha: 0).cgColor,
        UIColor(displayP3Red: 0, green: 0.25, blue: 0.25, alpha: 1.0).cgColor
    ]
...
func few_clouds(view: UIView) -> Void {
    let background = CAGradientLayer()
    background.frame = view.bounds
    background.colors = [
